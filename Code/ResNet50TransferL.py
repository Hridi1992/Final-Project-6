...
# ====================== MODEL ARCHITECTURE ======================
def efficient_transformer_block(x, num_heads=4, projection_dim=None, dropout=0.3):
...
def train_model(model, train_gen, val_gen,
                initial_epochs=30,
                fine_tune_epochs=50,
                final_tune_epochs=20):
    """Robust training with enhanced class weight handling"""
    # Get class counts directly from generator
