...
def build_mobilenet_model():
    ...
    x = layers.Lambda(mobilenet_preprocess)(x)  # Official ResNet50 preprocessing
...
def train_model(model, train_gen, val_gen, initial_epochs=1, fine_tune_epochs=1):
    ...
    print("\n=== Initial Training ===")
    model.get_layer("mobilenetv3").trainable = False
    model.compile(
...
def main():
    ...
    base_model = best_model.get_layer("mobilenetv3")
